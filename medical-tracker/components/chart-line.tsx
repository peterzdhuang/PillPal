...
export function ChartArea() {
  return (
    <Card>
      ...
      <CardHeader>
        <CardTitle className="flex justify-around items-center gap-x-[39rem]">Your Medication History at a Glance 
            <Button className="bg-primary text-secondary hover:bg-primary/70">
